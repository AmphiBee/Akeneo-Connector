...
use AmphiBee\AkeneoConnector\Api\CustomReferenceDataApi;
...
class AkeneoPimClientBuilder
{
    ...
    protected function buildAuthenticatedClient(Authentication $authentication): AkeneoPimClientInterface
    {
        ...
        $this->resources = collect('resourceClient', 'pageFactory', 'cursorFactory', 'fileSystem');
        ...
        $client = new AkeneoPimClient(
            ...
            # custom endpoints
            new CustomReferenceDataApi($resourceClient, $pageFactory, $cursorFactory)
        );
